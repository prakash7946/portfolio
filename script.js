        ...
        if (userMessage) {
            ...
            if (lowerMsg.includes("hello") || lowerMsg.includes("hi")) {
                ...
                chatElement.innerHTML = `<div class="eve-avatar-small"><div class="eve-face"><div class="eve-eye"></div><div class="eve-eye"></div></div></div>
                    ...
                    <strong>Email:</strong> <a href="mailto:prakashsiva2004429@gmail.com" style="color: var(--main-color); text-decoration: none;">prakashsiva2004429@gmail.com</a><br>
                    <strong>Phone:</strong> +91 9344709406<br><br>
                    <a href="https://wa.me/919344709406" target="_blank" style="color: var(--main-color); text-decoration: none; display: inline-flex; align-items: center; gap: 6px;"><svg width="16" height="16" viewBox="0 0 24 24" fill="#25D366"><path d="M.057 24l1.687-6.163c-1.041-1.804-1.588-3.849-1.587-5.946.003-6.556 5.338-11.891 11.893-11.891 3.181.001 6.167 1.24 8.413 3.488 2.245 2.248 3.481 5.236 3.48 8.414-.003 6.557-5.338 11.892-11.893 11.892-1.99-.001-3.951-.5-5.688-1.448l-6.305 1.654zm6.597-3.807c1.676.995 3.276 1.591 5.392 1.592 5.448 0 9.886-4.434 9.889-9.885.002-5.462-4.415-9.89-9.881-9.892-5.452 0-9.887 4.434-9.889 9.884-.001 2.225.651 3.891 1.746 5.634l-.999 3.648 3.742-.981z"/></svg> WhatsApp</a><br>
                    <a href="mailto:prakashsiva2004429@gmail.com" style="color: var(--main-color); text-decoration: none; display: inline-flex; align-items: center; gap: 6px;"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#38BDF8" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7"/><rect width="20" height="16" x="2" y="4" rx="2"/></svg> Email Me</a><br><br>
